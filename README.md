...
Partendo da un array di hotel assegnato dal docente, stamparli a schermo con tutti i dati disponibili; In seguito aggiungere via CDN il framework Bootstrap, mostrando i dati all interno di una tabella.
